...
//               </h1>
//               <p className="font-light text-base mt-2">Fill in the details and I&apos;ll get back to you as soon as I can!</p>
//             </header>
//             <div className="icons-container inline-flex flex-col my-20">
//               <div className = 'flex flex-row items-center space-x-6 rounded-md border border-[#02044A] hover:border hover:border-blue-500 p-4'>
//                 <p className='font-light text-sm'>
//                   My Phone: (425)-891-4115
//                 </p>
//               </div>
//               <div className="flex flex-row items-center space-x-6 rounded-md border border-[#02044A] hover:border hover:border-blue-500 p-4">
//                 <p className= "font-light text-sm">My Email: eden.lorrai@gmail.com</p>
//               </div>
//               <div className="flex flex-row items-center space-x-6 rounded-md border border-[#02044A] hover:border hover:border-blue-500 p-4">
//             </div>
//           </div>
...
//           <label htmlFor="name" className="text-sm mx-4">{" "} Your Name</label>
...
//           <label htmlFor='email' className='text-sm mx-4 mt-4'>Email</label>
...
//           <button type='submit' className='bg-teal-300 text-gray-900 rounded-md w-1/2 mx-4 mt-8 py-2 text-gray-50 text-xs font-bold'>
//             Send Message
//           </button>
//         </form>
//       </div>
